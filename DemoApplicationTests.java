...
public class DemoApplicationTests extends ConsumptionData{
	...
	@Test
	public void month() {
		final int expected = 2; // 1 == February
	...
	public void year2() {
		...
		final String actual = getLastYear();
		Assert.assertEquals(actual,expected);
	}

	@Test
	public void year3() {
		final String expected = "2019";
		final String actual = getCurrentYear();
		Assert.assertEquals(actual,expected);
	}

	@Test
	public void comment() throws IOException {
		final String expected = "Every week, we donate leftover clothes hangers to you, our customers! Find them by the Customer Service Desk.";
